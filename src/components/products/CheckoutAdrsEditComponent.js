...
class CheckoutAdrsEditComponent extends Component {
  render() {
    const { contactName, countryMobCode, contactMobNumber, houseNumber, street, landmark, pincode, village, isDefault, otherLocation, errorMsg, selectedOption, isDisable, disable, countryValue, stateValue, districtValue, districts, mandal, mandals, showOtherInput, backUrl } = this.props.state;
    const { setDefaultChange, handleOptionChange, handleChangeCountry, handleChangeState, handleChangeCity, handleChangeAreaLocality, updateAddress, handleNumerical, setStateData } = this.props
    return (
            ...
            <div className='row'>
              <div className='col-sm-4'>
                <div className='mb-3'>
                  ...
                  <input type='text' className='form-control' placeholder='Contact Person' value={contactName} onChange={(e) => setStateData({ contactName: e.target.value, errorMsg: '' })} />
                </div>
              </div>
              <div className='col-sm-4'>
                <div className='mb-3'>
                  ...
                  <div className='d-flex'>
                    ...
                    <input type='text' className='form-control' placeholder='Mobile No(#)' maxLength='10' value={contactMobNumber} onChange={(e) => setStateData({ contactMobNumber: e.target.value, errorMsg: '' })} onKeyPress={handleNumerical} />
                  </div>
                </div>
              </div>
              <div className='col-sm-4'>
              ...
              <div className='row d-flex justify-content between'>
                <div className='col-sm-6'>
                  <div className="form-check mt-4 pt-2">
                    <input className="form-check-input" type="checkbox" value={isDefault} disabled={isDefault === true ? disable : !disable} checked={isDefault} onChange={(e) => setDefaultChange(e)} />
              ...
              <div className='col-sm-12 text-center mt-3 pb-3'>
                <button className='btn btn-success px-4' disabled={isDisable} onClick={updateAddress}>Update Address</button>
              </div>
            </div>
          </div>
        </div>
...
export default CheckoutAdrsEditComponent;